        ...
        foreach($vol in $volumes)
          {
                    ...
                    #Send-GraphiteMetric -CarbonServer '10.10.0.168' -CarbonServerPort 2003 -MetricPath  "Clones.CAL1.$Cluster.Node.$Node.Aggr.$Aggr.$Volume.count" -MetricValue $Clonecount -DateTime (get-date)
                    Send-GraphiteMetric -CarbonServer '10.10.0.168' -CarbonServerPort 2003 -MetricPath  "Clones.VA2.$Cluster.Aggr.$Aggr.$Volume.count" -MetricValue $Clonecount -DateTime (get-date)
